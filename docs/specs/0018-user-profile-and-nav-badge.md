...
- [ ] Add the new badge/avatar pattern (circular, accent color, initials) to `docs/design/design.md` once built, so future avatar-like UI reuses it instead of inventing a new style.
